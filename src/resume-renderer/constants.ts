...
export const DEFAULT_LAYOUT_LINE_HEIGHT_PX = 22;
export const MIN_LAYOUT_LINE_HEIGHT_PX = 16;
export const MAX_LAYOUT_LINE_HEIGHT_PX = 32;
export const DEFAULT_LAYOUT_TITLE_MARGIN_TOP_PX = 0;
export const MIN_LAYOUT_TITLE_MARGIN_TOP_PX = 0;
export const MAX_LAYOUT_TITLE_MARGIN_TOP_PX = 30;
export const DEFAULT_LAYOUT_TITLE_MARGIN_BOTTOM_PX = 0;
export const MIN_LAYOUT_TITLE_MARGIN_BOTTOM_PX = 0;
export const MAX_LAYOUT_TITLE_MARGIN_BOTTOM_PX = 30;
export const DEFAULT_LAYOUT_FONT_SIZE_PX = 12.5;
export const MIN_LAYOUT_FONT_SIZE_PX = 10;
export const MAX_LAYOUT_FONT_SIZE_PX = 16;
