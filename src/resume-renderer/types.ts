...
export interface ResumeData { basics: ResumeBasics; summary?: string; experience: ResumeExperience[]; education: ResumeEducation[]; skills?: Record<string, string>; certificates?: ResumeCertificate[]; }
