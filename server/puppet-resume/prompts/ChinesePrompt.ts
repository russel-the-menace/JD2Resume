...
3. **技能列表 (Skills)**：
   - **核心目标**：技能区不是关键词堆砌，而是用极短的表达让招聘者立刻看出候选人能解决什么问题、如何工作、在哪些场景产生价值。
   - **表达规则**：每条技能点必须是“能力/方法 + 工作场景或交付动作”，优先写可执行、可观察的专业能力；禁止只写一个软件、平台、方法名或抽象名词。
   - **禁止低信息量写法**：不得单独输出“BOSS直聘”“结构化面试”“人才测评”“招聘数据分析”“PowerPoint”等孤立关键词；工具或渠道只有在和具体工作场景绑定时才可出现。
   - **推荐写法**：如“和候选人谈Offer、与业务部门对齐用人标准、向管理层汇报方案”“离职原因分析与招聘漏斗诊断”“主流招聘软件与国内外技术论坛的渠道组合”“基于STAR行为面试完成人才评估”。
   - **内容要求**：技能点应体现判断、沟通、分析、推动、评估、运营或交付等动作；优先使用候选人经历和目标岗位 JD 中的真实场景，不得凭空捏造具体业绩数字。
   - **语言要求**：**严禁使用 "精通"、"熟悉"、"掌握"、"了解" 等程度词**，但可以使用“设计、分析、拆解、推动、协调、评估、优化、落地”等动作词。
   - **结构强制要求**：**必须生成 4 组技能分类，且每组分类必须包含且仅包含 4 条技能点**。
   - **长度要求**：每条技能点控制在 **18 到 42 个视觉点**，通常是一句紧凑的能力短语，不写完整长职责，不使用句号收尾。
   - **分类要求**：分类标题要有岗位针对性，例如“沟通与影响力”“数据分析与逻辑思维”“招聘渠道与拓展”“招聘实操与评估”；禁止使用“其他”“综合能力”等空泛标题。
   - **针对性**：生成的技能组必须完全服务于"${targetTitle}"。
4. **排版 (Strict Quantity Control)**：
   - **加粗 (<b>)**：仅在个人介绍中使用 1-2 处，工作经历与其他字段禁止加粗。
   - **下划线 (<u>)**：每段工作经历仅选 1-2 条核心职责，每条仅标记一处简短关键数据或关键短语；不得给整句加下划线，内容不要求一定是数字。
5. **内容填充密度控制**：
